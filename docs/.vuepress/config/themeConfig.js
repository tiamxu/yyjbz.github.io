...
module.exports = {
  ...
  repo: 'tiamxu/kit', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: 'tiamxu', // 必需
    link: 'https://github.com/tiamxu', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: '/img/touxiang.jpeg',
    name: 'tiamxu',
    slogan: '一枚小小的搬运工',
  },
  social: {
    ...
    icons: [
      {
        ...
        title: 'GitHub',
        link: 'https://github.com/tiamxu',
      },
      {
        iconClass: 'icon-youjian',
        title: '发邮件',
        link: 'mailto:1218366090@qq.com',
      },
    ],
  },
  ...
  footer: {
    ...
    copyrightInfo:
    'Tiam Xu | <a href="https://www.cnblogs.com/xuliang666/" target="_blank">博客园</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
  },
}