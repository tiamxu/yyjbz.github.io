...
const feed_options = {
  canonical_base: 'https://wiki.gopron.online',
  count: 5000,
};
...
module.exports = [
  ...
  //       {
  //         title: '通过百度搜索本站的',
  //         frontUrl: `https://www.baidu.com/s?wd=site%3Awiki.gopron.online%20`,
  //       },
  //     ],
  //   }
  // ],
  ...
  //   {
  //     showIcon:
  //       "https://wiki.gopron.online/img/favicon.ico",
  //     showText: "ヾ(≧▽≦*)o欢迎回来！",
  //     hideIcon:
  //       "https://wiki.gopron.online/img/favicon.ico",
  //     hideText: "ಥ_ಥ不要走呀！",
  ...
  [
    'sitemap', {
      hostname: 'https://wiki.gopron.online',
      exclude: ["/404.html"],
    },
  ],
